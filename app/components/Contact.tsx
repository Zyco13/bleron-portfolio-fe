      ...
      <div className="grid md:grid-cols-2 gap-16 max-w-4xl w-full text-left">
        ...
        <div className="flex flex-col justify-center gap-6">
          {[
            {
              label: "Email",
              value: "bleronzekaj@icloud.com",
              href: "mailto:bleronzekaj@icloud.com",
            },
            {
              label: "GitHub",
              value: "github.com/Zyco13",
              href: "https://github.com/Zyco13",
            },
            {
              label: "LinkedIn",
              value: "linkedin.com/in/bleron-zekaj",
              href: "https://www.linkedin.com/in/bleron-zekaj-0ba225185/",
            },
          ].map((item) => (
            <div
              key={item.label}
